...
import mkcl.oesserver.services.IUserSessionServices;
...
public class LoginPost implements ApplicationContextAware {
	...
	private IUserSessionServices userSessionServices;
	...
	public String loginPost(Model model, @ModelAttribute(USERSTRING) LoginAccount user, BindingResult errors,
		...
		try {
           ...
           // Validate user
			...
			/* ***** BR #25081: LOG USER SESSION ***** */

			Date LoginDateTime = new Date();

			UserSession userSession = new UserSession();
			userSession.setUsername(dbUser.getLoginId());
			userSession.setStartTime(LoginDateTime);
			userSession.setEndTime(LoginDateTime);
			userSession.setDuration("00:00:00");

			Long userSessionId = userSessionServices.createUserSession(userSession);
			sessionWrap.addToSession(USER_SESSION_ID, userSessionId);
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		userSessionServices = (IUserSessionServices) applicationContext.getBean("UserSessionServices");
