					...
					<tbody>
						<c:forEach var="listObj" items="${UserList}">
							<tr>
								...
								<td><a href="actionSessionLogList?userId=${listObj.id}&userName=${listObj.firstName} ${listObj.thirdName}" class="btn btn-success btn-rounded btn-long btn-sm"><spring:message
							...
							$('#go')
									.click(
											function() {
												...
												window.location.href = '../actionLog/actionLogUserList?searchText='+ searchText;
											});
