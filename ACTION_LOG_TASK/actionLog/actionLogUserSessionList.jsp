	...
	<div class="row">
		...
		<div class="col-sm">
			<div  class="btn-group pull-right">
				<a class="btn btn-main btn-rounded btn-long btn-sm" style="margin-bottom: 20px" href="actionLogUserList"><spring:message code="actionLogSessionlist.userDetails" /></a> 
			</div>
		</div>
	</div>
					...
					<tbody>
						<c:forEach var="listObj" items="${UserSessionList}">
							<tr>
								...
								<td><a href="actionSummaryLogList?userSessionId=${listObj.sessionId}&startTime=${listObj.startTime}&endTime=${listObj.endTime}&userId=${userId}&userName=${userName}" class="btn btn-success btn-rounded btn-long btn-sm"><spring:message
							...
							$('#go')
									.click(
											function() {
												...
												window.location.href = '../actionLog/actionSessionLogList?searchText='+ searchText;
											});
