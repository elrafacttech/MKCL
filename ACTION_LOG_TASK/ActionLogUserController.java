...
public class ActionLogUserController extends PaginationHelper implements
    ...
    //Redirect Page
	private static final String USERLISTVIEW = "actionLog/actionLogUserList";
	private static final String USERSESSIONLISTVIEW = "actionLog/actionLogUserSessionList";
	private static final String USERSUMMARYSESSIONLISTVIEW = "actionLog/actionLogSessionSummaryList";
	...
	@RequestMapping(value = { "/actionSessionLogList" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = { "/actionSummaryLogList" }, method = RequestMethod.GET)
